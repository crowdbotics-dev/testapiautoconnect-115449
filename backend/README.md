...
## Project Structure
    ...
    ├── testapiautoconnect_115449  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_115449`
...
2. Clone this repo and `cd testapiautoconnect_115449`
